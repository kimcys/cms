...
class ViewPenyelenggaraanStaff {

    public static function form_PenyelenggaraanStaff($request) {
        ?>
<div class="col-md-12">
    <!-- begin panel -->
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = PenyelenggaraanStaff::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], PenyelenggaraanStaff::ajaxclick(), array(4, 6, 2));
                            ?>
