...
class ViewSpesifikasiStaff{

    public static function form_SpesifikasiStaff($request) {
        global $today;
...
<div class="container-md">
    ...
    <main class="main-container">
        <div class="main-cards">
            <?php
             $dataall = SpesifikasiStaff::sql_listgrid($request);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <a href="?do=<?php echo emenu($keymenu, 'm/m.specifikasistaff2') ?>&menu=Spesifikasi&pcId=<?php echo $pc_id ?>"
