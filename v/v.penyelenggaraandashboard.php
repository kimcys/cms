...
class ViewPenyelenggaraanDashboard {

    public static function form_PenyelenggaraanDashboard($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                ...
                <a onclick="<?php echo penyelenggaraanDashboard::ajaxclick()?>;"
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = penyelenggaraanDashboard::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], penyelenggaraanDashboard::ajaxclick(), array(4, 6, 2));
                            ?>
