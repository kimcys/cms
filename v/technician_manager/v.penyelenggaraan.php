...
class ViewPenyelenggaraan {

    public static function  form_Penyelenggaraan($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = Penyelenggaraan::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], Penyelenggaraan::ajaxclick(), array(4, 6, 2));
                            ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="?do=<?php echo emenu($keymenu, 'm/m.penyelenggaraan1') ?>&menu=Penyelenggaraan&deptId=<?php echo $dept_id ?>">
                                    <?php echo $dept_name ?>
                                </a>
                            </td>
                            <td>
