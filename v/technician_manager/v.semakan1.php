...
class ViewSemakan1 {
    ...
    public static function form_Semakan1($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                ...
                <a onclick="<?php echo Semakan1::ajaxclick()?>;" class="btn btn-xs btn-icon btn-circle btn-success"
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = Semakan1::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], Semakan1::ajaxclick(), array(4, 6, 2));
                            ?>
                        ...
                        <tr>
                            ...
                            <th width="10%">
                                ...
                                <button type="button" class="btn btn-xs btn-success"
                                    onclick="<?php echo Semakan1::ajaxclick("&add=1")?>">
                    ...
                    <tbody>
                        <?php
                                if (@$request['add'] == 1) {
                                    ?>
                        <tr>
                            <?php ViewSemakan1::form_add_edit(@$request); ?>
                        ...
                        <tr <?php if (@$request['edit'] == @$c_id) { echo 'class="active"'; } ?>>
                            <?php
                                                if (@$request['edit'] == @$c_id) {
                                                    ViewSemakan1::form_add_edit(@$request); 
                                                    $cls_icon = 'fa-save';
                                                    $cls_btn = 'btn-primary';
                                                    $btn_act = 'update';
                                                } else {
                            ...
                            <td>
                                <button type="button" class="btn btn-xs <?php echo $cls_btn ?>"
                                    onclick="<?php echo Semakan1::ajaxclick("&$btn_act=$c_id")?>">
                                    <i class="fa <?php echo $cls_icon ?> bigger-120"></i>
                                </button>
                                <button type="button" class="btn btn-xs btn-danger"
                                    onclick="if(confirm('<?php echo $GLOBALS['fw_lbl_confirm'] ?>'))<?php echo Semakan1::ajaxclick("&del=$c_id")?>">
        ...
        <div class="col-md-12">
            <center>
                <?php
                        ...
                        ?>
                <a onclick="<?php echo Semakan1::ajaxclick($btn_act)?>;" class="btn btn-primary"><i
                        class="fa fa-save bigger-120"></i> <?php echo $lbl_act ?></a>
                <a onclick="<?php echo Semakan1::ajaxclick()?>;" class="btn btn-warning"><i
