...
class ViewSpesifikasi {

    public static function form_Spesifikasi($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                ...
                <a onclick="<?php echo Spesifikasi::ajaxclick()?>;" class="btn btn-xs btn-icon btn-circle btn-success"
        ...
        <div class="panel-body">
            <?php
                            $dataall = Spesifikasi::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], Spesifikasi::ajaxclick(), array(4, 6, 2));

                            ?>
            <?php
            if (!@$request['edit']){ ?>
            <button type="button" class="btn btn-xs btn-success"
                onclick="<?php echo Spesifikasi::ajaxclick("&add=1")?>">
            ...
            <?php } 
                                ...
                                if (@$request['add'] == 1) {
                                    ?>
            <tr>
                <?php ViewSpesifikasi::form_add_edit(@$request); ?>
            ...
            ViewSpesifikasi::form_add_edit(@$request); 
                                                } else {
                                                    ?>
            ...
            <button type="button" class="btn btn-xs btn-info"
                onclick="<?php echo Spesifikasi::ajaxclick("&edit=$f_id")?>">
                <i class="fa fa-pencil bigger-120"></i> <?php echo lbl('KEMASKINI') ?>
            </button>
            <button type="button" class="btn btn-xs btn-danger"
                onclick="if(confirm('<?php echo $GLOBALS['fw_lbl_confirm'] ?>'))<?php echo Spesifikasi::ajaxclick("&del=$f_id")?>">
        ...
        <div class="col-md-12">
            <center>
                <?php
                        ...
                        ?>
                <a onclick="<?php echo Spesifikasi::ajaxclick($btn_act)?>;" class="btn btn-primary"><i
                        class="fa fa-save bigger-120"></i> <?php echo $lbl_act ?></a>
                <a onclick="<?php echo Spesifikasi::ajaxclick()?>;" class="btn btn-warning"><i
