...
class ViewPcTechnician {

    public static function form_PcTechnician($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                ...
                <a onclick="<?php echo PcTechnician::ajaxclick()?>;" class="btn btn-xs btn-icon btn-circle btn-success"
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = PcTechnician::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], PcTechnician::ajaxclick(), array(4, 6, 2));
                            ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="?do=<?php echo emenu($keymenu, 'm/m.pc2technician') ?>&menu=PC&deptId=<?php echo $dept_id ?>">
                                    <?php echo $dept_name  ?>
                                </a>
                            </td>
                            <td>
