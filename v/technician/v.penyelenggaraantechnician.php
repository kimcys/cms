...
class ViewPenyelenggaraanTechnician {

    public static function  form_PenyelenggaraanTechnician($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = PenyelenggaraanTechnician::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], PenyelenggaraanTechnician::ajaxclick(), array(4, 6, 2));
                            ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="?do=<?php echo emenu($keymenu, 'm/m.penyelenggaraan2tehnician') ?>&menu=Penyelenggaraan&deptId=<?php echo $dept_id ?>">
                                    <?php echo $dept_name ?>
                                </a>
                            </td>
                            <td>
                                <?php 
                                # to count total pc
                                echo Db::chkval('maintenance',"COUNT(dept_id)","dept_id=$dept_id");
                                ?>
                            </td>
                            <?php
                                                }
