...
class ViewPenyelenggaraan2Technician {

    public static function form_Penyelenggaraan2Technician($request) {
        global $today;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                ...
                <a onclick="<?php echo penyelenggaraan2Technician::ajaxclick()?>;"
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                            $dataall = penyelenggaraan2Technician::sql_listgrid($request);
                            Pagg::pagging_top(@$dataall['requestgrid'], @$dataall['totalreturned'], Penyelenggaraan2Technician::ajaxclick(), array(4, 6, 2));
                            ?>
                        ...
                        <tr>
                            ...
                            <th width="10%">
                                ...
                                <button type="button" class="btn btn-xs btn-success"
                                    onclick="<?php echo Penyelenggaraan2Technician::ajaxclick("&add=1")?>">
                    ...
                    <tbody>
                        <?php
                                if (@$request['add'] == 1) {
                                    ?>
                        <tr>
                            <?php ViewPenyelenggaraan2Technician::form_add_edit(@$request); ?>
                        ...
                        <tr <?php if (@$request['edit'] == @$m_id) { echo 'class="active"'; } ?>>
                            <?php
                                                if (@$request['edit'] == @$m_id) {
                                                    ViewPenyelenggaraan2Technician::form_add_edit(@$request); 
                                                    $cls_icon = 'fa-save';
                                                    $cls_btn = 'btn-primary';
                                                    $btn_act = 'update';
                                                } else {
                            ...
                            <td>
                                <button type="button" class="btn btn-xs <?php echo 'btn-success' ?>"
                                    onclick="<?php echo penyelenggaraan2Technician::ajaxclick("&$btn_act=$m_id")?>">
                                ...
                                <button type="button" class="btn btn-xs btn-danger"
                                    onclick="if(confirm('<?php echo $GLOBALS['fw_lbl_confirm'] ?>'))<?php echo Penyelenggaraan2Technician::ajaxclick("&del=$m_id")?>">
                ...
                <div class="b">
                    <button type="button" class="btn btn-xs <?php echo 'btn-success' ?>"
                        onclick="<?php echo penyelenggaraan2Technician::ajaxclick('&save=1')?>">
        ...
        <div class="col-md-12">
            <center>
                <?php
                        ...
                        ?>
                <a onclick="<?php echo Penyelenggaraan2Technician::ajaxclick($btn_act)?>;" class="btn btn-primary"><i
                        class="fa fa-save bigger-120"></i> <?php echo $lbl_act ?></a>
                <a onclick="<?php echo penyelenggaraan2Technician::ajaxclick()?>;" class="btn btn-warning"><i
