            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        ...
                        <a onclick="<?php echo Peranan::ajaxclick()?>;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-repeat"></i></a>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            ...
                            <th width="10%">
                                <?php if (!@$request['edit']){ ?>
                                <button type="button" class="btn btn-xs btn-success" onclick="<?php echo Peranan::ajaxclick("&add=1")?>">
                        ...
                        <tbody>
                                ...
                                if (@$request['edit'] != @$rr_id) {
                                    ?>
                                    <td>
                                        <button type="button" class="btn btn-xs <?php echo $cls_btn ?>" onclick="<?php echo Peranan::ajaxclick("&$btn_act=$rr_id")?>">
                                            <i class="fa <?php echo $cls_icon ?> bigger-120"></i>
                                        </button>
                                        <button type="button" class="btn btn-xs btn-danger" onclick="if(confirm('<?php echo $GLOBALS['fw_lbl_confirm'] ?>'))<?php echo Peranan::ajaxclick("&del=$rr_id")?>">
    ...
    public static function form_add_edit($data) {
        ...
        <td colspan='3'>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input name="rr_acronym" value="<?php echo @$rr_acronym ?>" class="form-control <?php echo FwSemak::alert_semak(@$chk_rr_acronym) ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label"><?php echo lbl('Description') ?></label>
                <div class="col-md-10">
                    <input name="rr_description" value="<?php echo @$rr_description ?>" class="form-control <?php echo FwSemak::alert_semak(@$chk_rr_description) ?>">
                </div>
                ...
                <div class="col-md-12">
                    <center>
                        ...
                        ?>
                        <a onclick="<?php echo Peranan::ajaxclick($btn_act)?>;" class="btn btn-primary"><i class="fa fa-save bigger-120"></i> <?php echo $lbl_act ?></a> 
                        <a onclick="<?php echo Peranan::ajaxclick()?>;" class="btn btn-warning"><i class="fa fa-times bigger-120"></i> Cancel</a>
                    </center>
                </div>
            </div>
        </td>
