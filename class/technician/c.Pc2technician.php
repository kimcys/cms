...
class Pc2Technician {
    ...
    public static function ajaxclick($get = '') {
        $idform = 'Pc2Technician';
        $divajax = 'divPc2Technician';
        $urlajax = Db::CFAjax('Pc2Technician', 'process');
    ...
    public static function process($data) {
        ...
        ViewPc2Technician::form_Pc2Technician(@$data);
    }
    ...
    {
        $sql = "select distinct block from department where dept_id='$a' order by block";
    ...
    {
        $sql = "select distinct level from department where dept_id='$a' and  block='$b' order by level";
    ...
    {
        $sql = "select distinct wing from department where dept_id='$a' and block='$b' and level='$c' order by wing";
    ...
    {
        $sql = "select distinct room from department where dept_id='$a' and block='$b' and level ='$c' and wing='$d'  order by room";
